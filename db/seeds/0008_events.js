  ...
  return knex('events').del()
    .then(function () {
      ...
      return knex('events').insert([
        ...
        {title: 'BRING IT ON DANCE', description: 'dance competition', img_url: 'Bring_It_On_April_2019.png', date: '2019/04/20', time: '12:00pm', venue: 'Warren Central HS', address: '', isActive: true}
      ]);
    });
};
